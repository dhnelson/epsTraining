...
<div class="row">
    ...
    <div class="col-sm-4 contact-box-spacing">
        <div class="well">
            <dl>
            ...
            <dl>
                <dt class="red">See the <a href="{{ route('facility') }}">Facility Page</a> for more details about the gym's address, hours, and location</dt>
            </dl> 
        </div>
    </div>
</div>
